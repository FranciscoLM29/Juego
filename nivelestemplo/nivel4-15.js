...
export class Zona4N15 extends Phaser.Scene {
    constructor() {
        super({ key: 'nt15' });
    }
    ...
    createItems() {
        ...
        const itemPositions = [
            ...
            { item: 'red', x: 2, y: 2 },
            { item: 'green', x: 7, y: 3 },
            { item: 'yellow', x: 12, y: 2 },
            { item: 'purple', x: 13, y: 1 }
        ];
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level60Time', elapsedTime); // Almacenar tiempo del nivel 1
