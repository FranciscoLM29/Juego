...
export class Zona4N11 extends Phaser.Scene {
    constructor() {
        super({ key: 'nt11' });
    }
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level56Time', elapsedTime); // Almacenar tiempo del nivel 1
