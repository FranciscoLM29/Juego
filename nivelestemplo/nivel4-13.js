...
export class Zona4N13 extends Phaser.Scene {
    constructor() {
        super({ key: 'nt13' });
    }
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level58Time', elapsedTime); // Almacenar tiempo del nivel 1
