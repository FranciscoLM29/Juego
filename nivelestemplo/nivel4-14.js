...
export class Zona4N14 extends Phaser.Scene {
    constructor() {
        super({ key: 'nt14' });
    }
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level59Time', elapsedTime); // Almacenar tiempo del nivel 1
