...
export class Zona4N7 extends Phaser.Scene {
    constructor() {
        super({ key: 'nt7' });
    }
    ...
    createPlatforms() {
        ...
        const platformPositions = [
            ...
            { item: 'red', x: 14, y: 5 },
            { item: 'green', x: 14, y: 4 },
            { item: 'yellow', x: 13, y: 6 },
            { item: 'purple', x: 12, y: 6 }
        ];
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level52Time', elapsedTime); // Almacenar tiempo del nivel 1
