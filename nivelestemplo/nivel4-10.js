...
export class Zona4N10 extends Phaser.Scene {
    constructor() {
        super({ key: 'nt10' });
    }
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level55Time', elapsedTime); // Almacenar tiempo del nivel 1
