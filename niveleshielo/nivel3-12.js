...
export class Zona3N12 extends Phaser.Scene {
    constructor() {
        super({ key: 'nh12' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 1, y: 5 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level42Time', elapsedTime); // Almacenar tiempo del nivel 1
