...
export class Zona3N4 extends Phaser.Scene {
    constructor() {
        super({ key: 'nh4' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 7, y: 3 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level34Time', elapsedTime); // Almacenar tiempo del nivel 1
