...
export class Zona3N7 extends Phaser.Scene {
    constructor() {
        super({ key: 'nh7' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 8, y: 0 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level37Time', elapsedTime); // Almacenar tiempo del nivel 1
