...
const GRID_HEIGHT = 6;  // Número de filas

export class Zona3N6 extends Phaser.Scene {
    constructor() {
        super({ key: 'nh6' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 7, y: 2 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level36Time', elapsedTime); // Almacenar tiempo del nivel 1
