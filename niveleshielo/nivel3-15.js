...
export class Zona3N15 extends Phaser.Scene {
    constructor() {
        super({ key: 'nh15' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 5, y: 2 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level45Time', elapsedTime); // Almacenar tiempo del nivel 1
