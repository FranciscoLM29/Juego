...
export class Zona3N8 extends Phaser.Scene {
    constructor() {
        super({ key: 'nh8' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 5, y: 4 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level38Time', elapsedTime); // Almacenar tiempo del nivel 1
