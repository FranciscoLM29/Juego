...
const GRID_WIDTH = 9;  // Número de columnas
const GRID_HEIGHT = 6;  // Número de filas

export class Zona3N5 extends Phaser.Scene {
    constructor() {
        super({ key: 'nh5' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 4, y: 0 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level35Time', elapsedTime); // Almacenar tiempo del nivel 1
