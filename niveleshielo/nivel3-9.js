...
export class Zona3N9 extends Phaser.Scene {
    constructor() {
        super({ key: 'nh9' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 9, y: 5 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level39Time', elapsedTime); // Almacenar tiempo del nivel 1
