...
export class Zona3N14 extends Phaser.Scene {
    constructor() {
        super({ key: 'nh14' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 7, y: 0 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level44Time', elapsedTime); // Almacenar tiempo del nivel 1
