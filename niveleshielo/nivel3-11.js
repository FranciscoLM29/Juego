...
export class Zona3N11 extends Phaser.Scene {
    constructor() {
        super({ key: 'nh11' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 10, y: 6 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level41Time', elapsedTime); // Almacenar tiempo del nivel 1
