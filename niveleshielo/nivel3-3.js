...
export class Zona3N3 extends Phaser.Scene {
    constructor() {
        super({ key: 'nh3' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 6, y: 0 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level33Time', elapsedTime); // Almacenar tiempo del nivel 1
