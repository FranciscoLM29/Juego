...
const GRID_WIDTH = 8;  // Número de columnas
const GRID_HEIGHT = 5;  // Número de filas

export class Zona3N2 extends Phaser.Scene {
    constructor() {
        super({ key: 'nh2' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 1, y: 0 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level32Time', elapsedTime); // Almacenar tiempo del nivel 1
