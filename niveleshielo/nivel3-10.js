...
export class Zona3N10 extends Phaser.Scene {
    constructor() {
        super({ key: 'nh10' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 9, y: 1 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level40Time', elapsedTime); // Almacenar tiempo del nivel 1
