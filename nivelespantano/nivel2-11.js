...
export class Zona2N11 extends Phaser.Scene {
    constructor() {
        super({ key: 'np11' });
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level26Time', elapsedTime); // Almacenar tiempo del nivel
