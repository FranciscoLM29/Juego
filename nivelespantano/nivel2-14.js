...
export class Zona2N14 extends Phaser.Scene {
    constructor() {
        super({ key: 'np14' });
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level29Time', elapsedTime); // Almacenar tiempo del nivel
