...
const INITIAL_PIPES = [
    { gridX: 8, gridY: 1, type: 'corner-ur', locked: true },
    { gridX: 10, gridY: 4, type: 'corner-ur', locked: true },
    { gridX: 6, gridY: 3, type: 'corner-dr', locked: true },
    { gridX: 6, gridY: 5, type: 'straight-v', locked: true },
    { gridX: 8, gridY: 0, type: 'straight-v', locked: true },
    { gridX: 10, gridY: 0, type: 'straight-v', locked: true },
    { gridX: 9, gridY: 1, type: 'straight-h', locked: true },
    { gridX: 11, gridY: 3, type: 'straight-h', locked: true },
    { gridX: 11, gridY: 4, type: 'straight-h', locked: true },
    { gridX: 1, gridY: 1, type: 'cross', locked: false },
    { gridX: 3, gridY: 1, type: 'cross', locked: false },
    { gridX: 2, gridY: 5, type: 'straight-h', locked: false },
    { gridX: 3, gridY: 4, type: 'straight-h', locked: false },
    { gridX: 4, gridY: 3, type: 'straight-h', locked: false },
    { gridX: 2, gridY: 2, type: 'straight-v', locked: false },
    { gridX: 5, gridY: 1, type: 'straight-v', locked: false }
];
...
export class Zona5N6 extends Phaser.Scene {
    constructor() {
        super({ key: 'nl6' });
    }
    ...
    create() {
        ...
        this.startPipe = this.addInitialPipe(6, 6, 'pipe-start', ['up']);
        this.endPipe = this.addFinalPipe(11, 1, 'pipe-end', ['left']);
        ...
        this.gridPosition = { x: 2, y: 1 }; // Posición inicial del jugador
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level66Time', elapsedTime); // Almacenar tiempo del nivel 1
