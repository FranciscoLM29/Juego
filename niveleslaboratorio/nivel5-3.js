...
const INITIAL_PIPES = [
    { gridX: 1, gridY: 2, type: 'corner-dr', locked: true },
    { gridX: 3, gridY: 2, type: 'corner-dl', locked: true },
    { gridX: 8, gridY: 6, type: 'corner-ur', locked: true },
    { gridX: 1, gridY: 4, type: 'straight-v', locked: true },
    { gridX: 1, gridY: 3, type: 'straight-v', locked: true },
    { gridX: 2, gridY: 2, type: 'straight-h', locked: true },
    { gridX: 7, gridY: 5, type: 'straight-h', locked: true },
    { gridX: 9, gridY: 5, type: 'straight-h', locked: true },
    { gridX: 8, gridY: 5, type: 'T_down', locked: true },
    { gridX: 8, gridY: 3, type: 'corner-ur', locked: false },
    { gridX: 5, gridY: 1, type: 'corner-ur', locked: false },
    { gridX: 8, gridY: 1, type: 'corner-dl', locked: false },
    { gridX: 1, gridY: 5, type: 'straight-h', locked: false },
    { gridX: 2, gridY: 1, type: 'straight-h', locked: false },
    { gridX: 6, gridY: 5, type: 'straight-v', locked: false }
];
...
export class Zona5N3 extends Phaser.Scene {
    constructor() {
        super({ key: 'nl3' });
    }
    ...
    create() {
        ...
        this.endPipe = this.addFinalPipe(9, 6, 'pipe-end', ['left']);
        ...
        this.gridPosition = { x: 2, y: 3 }; // Posición inicial del jugador
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level63Time', elapsedTime); // Almacenar tiempo del nivel 1
