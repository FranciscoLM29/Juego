...
const INITIAL_PIPES = [
    { gridX: 1, gridY: 5, type: 'corner-dr', locked: true },
    { gridX: 2, gridY: 4, type: 'corner-dr', locked: true },
    { gridX: 9, gridY: 2, type: 'corner-dr', locked: true },
    { gridX: 9, gridY: 5, type: 'corner-ur', locked: true },
    { gridX: 2, gridY: 5, type: 'corner-ul', locked: true },
    { gridX: 3, gridY: 4, type: 'straight-h', locked: true },
    { gridX: 10, gridY: 2, type: 'straight-h', locked: true },
    { gridX: 10, gridY: 3, type: 'straight-h', locked: true },
    { gridX: 9, gridY: 4, type: 'straight-v', locked: true },
    { gridX: 5, gridY: 1, type: 'cross', locked: false },
    { gridX: 7, gridY: 1, type: 'corner-dr', locked: false },
    { gridX: 5, gridY: 5, type: 'corner-ul', locked: false },
    { gridX: 1, gridY: 1, type: 'straight-h', locked: false },
    { gridX: 3, gridY: 1, type: 'straight-h', locked: false },
    { gridX: 9, gridY: 1, type: 'straight-h', locked: false },
    { gridX: 2, gridY: 2, type: 'straight-h', locked: false }
];
...
export class Zona5N4 extends Phaser.Scene {
    constructor() {
        super({ key: 'nl4' });
    }
    ...
    create() {
        ...
        this.startPipe = this.addInitialPipe(1, 6, 'pipe-start', ['up']);
        this.endPipe = this.addFinalPipe(10, 5, 'pipe-end', ['left']);
        ...
        this.gridPosition = { x: 1, y: 4 }; // Posición inicial del jugador
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level64Time', elapsedTime); // Almacenar tiempo del nivel 1
