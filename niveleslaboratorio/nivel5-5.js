...
const INITIAL_PIPES = [
    { gridX: 9, gridY: 6, type: 'corner-ur', locked: true },
    { gridX: 7, gridY: 4, type: 'straight-h', locked: true },
    { gridX: 9, gridY: 2, type: 'corner-dr', locked: false },
    ...
    { gridX: 4, gridY: 2, type: 'straight-v', locked: false },
    { gridX: 7, gridY: 1, type: 'straight-v', locked: false }
];
...
export class Zona5N5 extends Phaser.Scene {
    constructor() {
        super({ key: 'nl5' });
    }
    ...
    create() {
        ...
        this.startPipe = this.addInitialPipe(4, 6, 'pipe-start', ['up']);
        this.endPipe = this.addFinalPipe(10, 6, 'pipe-end', ['left']);
        ...
        this.gridPosition = { x: 4, y: 4 }; // Posición inicial del jugador
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level65Time', elapsedTime); // Almacenar tiempo del nivel 1
