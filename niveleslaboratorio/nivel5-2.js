...
const INITIAL_PIPES = [
    { gridX: 2, gridY: 3, type: 'corner-dr', locked: true },
    { gridX: 4, gridY: 3, type: 'corner-ul', locked: true },
    { gridX: 2, gridY: 4, type: 'straight-v', locked: true },
    { gridX: 2, gridY: 5, type: 'straight-v', locked: true },
    { gridX: 5, gridY: 2, type: 'straight-h', locked: true },
    { gridX: 1, gridY: 2, type: 'corner-dr', locked: false },
    { gridX: 1, gridY: 4, type: 'straight-h', locked: false },
    { gridX: 5, gridY: 5, type: 'straight-h', locked: false },
...
export class Zona5N2 extends Phaser.Scene {
    constructor() {
        super({ key: 'nl2' });
    }
    ...
    create() {
        ...
        this.startPipe = this.addInitialPipe(2, 6, 'pipe-start', ['up']);
        this.endPipe = this.addFinalPipe(9, 2, 'pipe-end', ['left']);
        ...
        this.gridPosition = { x: 6, y: 5 }; // Posición inicial del jugador
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level62Time', elapsedTime); // Almacenar tiempo del nivel 1
