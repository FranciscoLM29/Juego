...
const INITIAL_PIPES = [
    { gridX: 8, gridY: 4, type: 'corner-dr', locked: false },
    { gridX: 1, gridY: 2, type: 'straight-v', locked: false },
    { gridX: 8, gridY: 2, type: 'straight-h', locked: true },
    { gridX: 8, gridY: 3, type: 'straight-v', locked: false },
    { gridX: 5, gridY: 4, type: 'straight-h', locked: false },
    { gridX: 7, gridY: 4, type: 'straight-h', locked: false }
];
...
export class Zona5N1 extends Phaser.Scene {
    constructor() {
        super({ key: 'nl1' });
    }
    ...
    create() {
        ...
        this.startPipe = this.addInitialPipe(5, 5, 'pipe-start', ['up']);
        ...
        this.gridPosition = { x: 3, y: 0 }; // Posición inicial del jugador
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level61Time', elapsedTime); // Almacenar tiempo del nivel 1
