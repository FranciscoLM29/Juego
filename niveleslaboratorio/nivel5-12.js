...
const INITIAL_PIPES = [
    { gridX: 3, gridY: 1, type: 'straight-v', locked: false },
    { gridX: 3, gridY: 2, type: 'straight-v', locked: false },
    { gridX: 3, gridY: 0, type: 'straight-v', locked: false },
    { gridX: 12, gridY: 4, type: 'straight-v', locked: false },
    { gridX: 12, gridY: 6, type: 'straight-v', locked: false },
    { gridX: 12, gridY: 5, type: 'straight-v', locked: false },
    { gridX: 12, gridY: 7, type: 'straight-v', locked: false },
    { gridX: 0, gridY: 3, type: 'straight-h', locked: false },
    { gridX: 1, gridY: 3, type: 'straight-h', locked: false },
    { gridX: 2, gridY: 3, type: 'straight-h', locked: false },
    { gridX: 9, gridY: 1, type: 'straight-h', locked: false },
    { gridX: 9, gridY: 5, type: 'straight-h', locked: false },
    { gridX: 8, gridY: 1, type: 'straight-h', locked: false },
    { gridX: 8, gridY: 5, type: 'straight-h', locked: false },
    { gridX: 7, gridY: 1, type: 'straight-h', locked: false },
    { gridX: 7, gridY: 5, type: 'straight-h', locked: false },
    { gridX: 6, gridY: 1, type: 'straight-h', locked: false },
    { gridX: 6, gridY: 5, type: 'straight-h', locked: false },
    { gridX: 13, gridY: 3, type: 'straight-h', locked: false },
    { gridX: 14, gridY: 3, type: 'straight-h', locked: false },
    { gridX: 15, gridY: 3, type: 'straight-h', locked: false },
    { gridX: 12, gridY: 3, type: 'corner-dr', locked: false },
    { gridX: 3, gridY: 3, type: 'corner-ul', locked: false }
];
...
export class Zona5N12 extends Phaser.Scene {
    constructor() {
        super({ key: 'nl12' });
    }
    ...
    create() {
        ...
        this.startPipe = this.addInitialPipe(7, 7, 'pipe-start', ['up']);
        this.endPipe = this.addFinalPipe(15, 6, 'pipe-end', ['left']);
        ...
        this.gridPosition = { x: 1, y: 1 }; // Posición inicial del jugador
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level72Time', elapsedTime); // Almacenar tiempo del nivel 1
