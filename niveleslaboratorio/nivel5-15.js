...
const INITIAL_PIPES = [
    { gridX: 15, gridY: 6, type: 'T_left', locked: false },
    { gridX: 12, gridY: 6, type: 'T_right', locked: true },
    { gridX: 3, gridY: 6, type: 'corner-ur', locked: true },
    { gridX: 2, gridY: 1, type: 'corner-dl', locked: false },
    { gridX: 10, gridY: 6, type: 'corner-dl', locked: false },
    { gridX: 10, gridY: 4, type: 'corner-ul', locked: true },
    { gridX: 4, gridY: 2, type: 'corner-ul', locked: false },
    { gridX: 6, gridY: 4, type: 'corner-dr', locked: true },
    { gridX: 12, gridY: 5, type: 'corner-dr', locked: true },
    { gridX: 6, gridY: 1, type: 'corner-dr', locked: false },
    { gridX: 11, gridY: 1, type: 'corner-dr', locked: false },
    { gridX: 13, gridY: 6, type: 'cross', locked: true },
    { gridX: 6, gridY: 5, type: 'straight-v', locked: true },
    { gridX: 10, gridY: 3, type: 'straight-v', locked: true },
    { gridX: 12, gridY: 7, type: 'straight-v', locked: true },
    { gridX: 13, gridY: 7, type: 'straight-v', locked: true },
    { gridX: 13, gridY: 4, type: 'straight-v', locked: true },
    { gridX: 13, gridY: 3, type: 'straight-v', locked: true },
    { gridX: 1, gridY: 1, type: 'straight-v', locked: false },
    { gridX: 2, gridY: 5, type: 'straight-h', locked: true },
    { gridX: 7, gridY: 4, type: 'straight-h', locked: true },
    { gridX: 8, gridY: 4, type: 'straight-h', locked: true },
    { gridX: 9, gridY: 4, type: 'straight-h', locked: true },
    { gridX: 14, gridY: 6, type: 'straight-h', locked: true },
    { gridX: 6, gridY: 6, type: 'straight-h', locked: false },
    { gridX: 8, gridY: 3, type: 'straight-h', locked: false },
    { gridX: 8, gridY: 5, type: 'straight-h', locked: false },
    { gridX: 10, gridY: 2, type: 'straight-h', locked: false },
    { gridX: 14, gridY: 1, type: 'straight-h', locked: false }
];
...
export class Zona5N15 extends Phaser.Scene {
    constructor() {
        super({ key: 'nl15' });
    }
    ...
    create() {
        ...
        this.startPipe = this.addInitialPipe(1, 7, 'pipe-start', ['up']);
        this.endPipe = this.addFinalPipe(16, 6, 'pipe-end', ['left']);
        ...
        this.gridPosition = { x: 16, y: 7 }; // Posición inicial del jugador
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level75Time', elapsedTime); // Almacenar tiempo del nivel 1
