...
const INITIAL_PIPES = [
    ...
    { gridX: 13, gridY: 1, type: 'corner-dr', locked: false },
    { gridX: 2, gridY: 3, type: 'corner-ur', locked: false },
    { gridX: 3, gridY: 4, type: 'straight-v', locked: false },
    { gridX: 5, gridY: 4, type: 'straight-v', locked: false },
    { gridX: 5, gridY: 6, type: 'straight-v', locked: false },
    { gridX: 7, gridY: 4, type: 'straight-v', locked: false },
    { gridX: 8, gridY: 2, type: 'straight-v', locked: false },
    { gridX: 3, gridY: 2, type: 'straight-h', locked: false },
    { gridX: 3, gridY: 6, type: 'straight-h', locked: false },
    { gridX: 4, gridY: 5, type: 'straight-h', locked: false },
    { gridX: 4, gridY: 3, type: 'straight-h', locked: false },
    { gridX: 6, gridY: 2, type: 'straight-h', locked: false },
    { gridX: 6, gridY: 5, type: 'straight-h', locked: false },
    { gridX: 7, gridY: 3, type: 'straight-h', locked: false },
    { gridX: 7, gridY: 7, type: 'straight-h', locked: false },
    { gridX: 8, gridY: 6, type: 'straight-h', locked: false },
    { gridX: 9, gridY: 3, type: 'straight-h', locked: false },
    { gridX: 9, gridY: 4, type: 'straight-h', locked: false },
    { gridX: 9, gridY: 6, type: 'straight-h', locked: false },
    { gridX: 10, gridY: 5, type: 'straight-h', locked: false },
    { gridX: 11, gridY: 5, type: 'straight-h', locked: false }
];
...
export class Zona5N11 extends Phaser.Scene {
    constructor() {
        super({ key: 'nl11' });
    }
    ...
    create() {
        ...
        this.startPipe = this.addInitialPipe(14, 7, 'pipe-start', ['up']);
        this.endPipe = this.addFinalPipe(14, 0, 'pipe-end', ['left']);
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level71Time', elapsedTime); // Almacenar tiempo del nivel 1
