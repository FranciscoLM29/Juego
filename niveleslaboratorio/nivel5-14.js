...
const INITIAL_PIPES = [
    { gridX: 12, gridY: 1, type: 'T_up', locked: true },
    { gridX: 14, gridY: 2, type: 'T_right', locked: true },
    { gridX: 10, gridY: 1, type: 'corner-ur', locked: true },
    { gridX: 14, gridY: 1, type: 'corner-dl', locked: true },
    { gridX: 11, gridY: 5, type: 'corner-ul', locked: true },
    { gridX: 13, gridY: 7, type: 'corner-dr', locked: true },
    { gridX: 8, gridY: 5, type: 'corner-dr', locked: true },
    { gridX: 11, gridY: 3, type: 'corner-dr', locked: false },
    { gridX: 0, gridY: 4, type: 'cross', locked: false },
    { gridX: 0, gridY: 2, type: 'cross', locked: false },
    { gridX: 0, gridY: 6, type: 'cross', locked: false },
    { gridX: 1, gridY: 1, type: 'cross', locked: false },
    { gridX: 1, gridY: 7, type: 'cross', locked: false },
    { gridX: 1, gridY: 3, type: 'cross', locked: false },
    { gridX: 1, gridY: 5, type: 'cross', locked: false },
    { gridX: 2, gridY: 4, type: 'cross', locked: false },
    { gridX: 2, gridY: 6, type: 'cross', locked: false },
    { gridX: 2, gridY: 0, type: 'cross', locked: false },
    { gridX: 2, gridY: 2, type: 'cross', locked: false },
    { gridX: 3, gridY: 3, type: 'cross', locked: false },
    { gridX: 3, gridY: 1, type: 'cross', locked: false },
    { gridX: 3, gridY: 7, type: 'cross', locked: false },
    { gridX: 4, gridY: 0, type: 'cross', locked: false },
    { gridX: 4, gridY: 2, type: 'cross', locked: false },
    { gridX: 4, gridY: 6, type: 'cross', locked: false },
    { gridX: 5, gridY: 7, type: 'cross', locked: false },
    { gridX: 5, gridY: 1, type: 'cross', locked: false },
    { gridX: 5, gridY: 3, type: 'cross', locked: false },
    { gridX: 14, gridY: 4, type: 'cross', locked: true },
    { gridX: 14, gridY: 7, type: 'cross', locked: true },
    { gridX: 10, gridY: 0, type: 'straight-v', locked: true },
    { gridX: 12, gridY: 0, type: 'straight-v', locked: true },
    { gridX: 14, gridY: 6, type: 'straight-v', locked: true },
    { gridX: 14, gridY: 3, type: 'straight-v', locked: true },
    { gridX: 8, gridY: 2, type: 'straight-v', locked: false },
    { gridX: 9, gridY: 1, type: 'straight-v', locked: false },
    { gridX: 11, gridY: 1, type: 'straight-h', locked: true },
    { gridX: 13, gridY: 1, type: 'straight-h', locked: true },
    { gridX: 15, gridY: 2, type: 'straight-h', locked: true },
    { gridX: 15, gridY: 4, type: 'straight-h', locked: true },
    { gridX: 8, gridY: 6, type: 'straight-h', locked: false },
    { gridX: 11, gridY: 4, type: 'straight-h', locked: false },
    { gridX: 11, gridY: 6, type: 'straight-h', locked: false },
    { gridX: 9, gridY: 3, type: 'straight-h', locked: false }
];
...
export class Zona5N14 extends Phaser.Scene {
    constructor() {
        super({ key: 'nl14' });
    }
    ...
    create() {
        ...
        this.startPipe = this.addInitialPipe(8, 7, 'pipe-start', ['up']);
        this.endPipe = this.addFinalPipe(15, 7, 'pipe-end', ['left']);
        ...
        this.gridPosition = { x: 0, y: 0 }; // Posición inicial del jugador
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level74Time', elapsedTime); // Almacenar tiempo del nivel 1
