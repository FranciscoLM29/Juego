...
const INITIAL_PIPES = [
    { gridX: 0, gridY: 4, type: 'straight-v', locked: false },
    { gridX: 2, gridY: 2, type: 'straight-v', locked: false },
    { gridX: 9, gridY: 5, type: 'straight-v', locked: false },
    { gridX: 9, gridY: 6, type: 'straight-v', locked: false },
    { gridX: 9, gridY: 7, type: 'straight-v', locked: false },
    { gridX: 0, gridY: 0, type: 'straight-h', locked: false },
    { gridX: 4, gridY: 0, type: 'straight-h', locked: false },
    { gridX: 6, gridY: 5, type: 'straight-h', locked: false },
    { gridX: 6, gridY: 6, type: 'straight-h', locked: false },
    { gridX: 6, gridY: 7, type: 'straight-h', locked: false },
    { gridX: 0, gridY: 2, type: 'corner-ur', locked: false },
    { gridX: 9, gridY: 0, type: 'corner-ur', locked: false },
    { gridX: 9, gridY: 1, type: 'corner-ur', locked: false },
    { gridX: 1, gridY: 1, type: 'corner-dl', locked: false },
    { gridX: 2, gridY: 0, type: 'corner-dl', locked: false },
    { gridX: 7, gridY: 0, type: 'corner-dl', locked: false },
    { gridX: 7, gridY: 1, type: 'corner-dl', locked: false },
    { gridX: 1, gridY: 3, type: 'corner-ul', locked: false },
    { gridX: 3, gridY: 1, type: 'corner-ul', locked: false },
    { gridX: 8, gridY: 3, type: 'corner-ul', locked: false },
    { gridX: 8, gridY: 2, type: 'corner-ul', locked: false },
    { gridX: 11, gridY: 2, type: 'corner-dr', locked: false },
    { gridX: 11, gridY: 3, type: 'corner-dr', locked: false },
    { gridX: 13, gridY: 4, type: 'corner-dr', locked: false }
];
...
export class Zona5N10 extends Phaser.Scene {
    constructor() {
        super({ key: 'nl10' });
    }
    ...
    create() {
        ...
        this.endPipe = this.addFinalPipe(14, 6, 'pipe-end', ['left']);
    ...
    completeLevel(time) {
        ...
        localStorage.setItem('level70Time', elapsedTime); // Almacenar tiempo del nivel 1
