...
const GRID_WIDTH = 10;  // Número de columnas
const GRID_HEIGHT = 8;  // Número de filas

export class Zona1N2 extends Phaser.Scene {
    constructor() {
        super({ key: 'nc2' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 5, y: 1 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        const previousTime = parseFloat(localStorage.getItem('level2Time')) || Infinity;
        ...
        localStorage.setItem('level2Time', elapsedTime); // Almacenar tiempo del nivel 1
