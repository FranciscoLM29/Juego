...
export class Zona1N1 extends Phaser.Scene {
    constructor() {
        super({ key: 'nc1' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 8, y: 1 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        const previousTime = parseFloat(localStorage.getItem('level1Time')) || Infinity;
        ...
        localStorage.setItem('level1Time', elapsedTime); // Almacenar tiempo del nivel 1
