...
export class Zona1N3 extends Phaser.Scene {
    constructor() {
        super({ key: 'nc3' });
    }
    ...
    create() {
        ...
        this.itemPosition = { x: 8, y: 3 }; // Ubicación del objeto en la cuadrícula
    ...
    completeLevel(time) {
        ...
        const previousTime = parseFloat(localStorage.getItem('level3Time')) || Infinity;
        ...
        localStorage.setItem('level3Time', elapsedTime); // Almacenar tiempo del nivel 1
