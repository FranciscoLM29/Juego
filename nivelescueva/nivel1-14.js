...
export class Zona1N14 extends Phaser.Scene {
    constructor() {
        super({ key: 'nc14' });
        ...
        this.grids = [
            {
                background: 'cueva',
                ladders: [
                    { x: 5, y: 1, connectsTo: 2 },
                    { x: 14, y: 6, connectsTo: 3 }
                ],
                itemPosition: { x: 9, y: 1 },
                rocks: {
                    fixed: [
                        { x: 7, y: 0 },
                        { x: 7, y: 1 },
            ...
            },
            {
                background: 'cueva',
                ladders: [
                    { x: 9, y: 2, connectsTo: 1 },
                    { x: 6, y: 4, connectsTo: 3 }
                ],
            ...
            },
            {
                background: 'cueva',
                ladders: [
                    { x: 15, y: 7, connectsTo: 1 },
                    { x: 0, y: 0, connectsTo: 2 }
                ],
                itemPosition: { x: 20, y: 20 },
                rocks: {
                    fixed: [
    ...
    completeLevel(time) {
        ...
        const previousTime = parseFloat(localStorage.getItem('level14Time')) || Infinity;
        if (elapsedTime < previousTime) {
            localStorage.setItem('level14Time', elapsedTime);
        }
    
        // Guardar el tiempo en el localStorage con el nombre del nivel
        localStorage.setItem('level14Time', elapsedTime); // Almacenar tiempo del nivel 6
